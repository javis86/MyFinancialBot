...
3. Save the key (referred to as `GEMINI_API_KEY`).
   > 💡 **Model Note**: Use `gemini-2.5-flash`. Models like `gemini-3.6-flash` or `gemini-2.0-flash` may experience capacity/demand issues or deprecation on free-tier keys.
